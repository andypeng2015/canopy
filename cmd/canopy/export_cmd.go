...
func newExportCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "export [path]",
		Short: "Export structural index to a portable .canopyindex file",
	...
	cmd.Flags().StringVarP(&output, "output", "o", "", "output path (default: <repo-name>.canopyindex)")
